    ...
    return (
        <nav className="flex flex-col justify-between h-full p-10 fixed right-0 top-0 w-[12vw] min-w-[120px]">
            ...
            <div className="flex justify-end">
                ...
                <div className={` ${i18n.language === 'ua' ? "font-semibold" : "font-normal"} text-xl cursor-pointer "`} onClick={ () =>switchLanguage('ua')}>ua</div>

                <div className="text-xl px-3">|</div>


                <div className={` ${i18n.language === 'en' ? "font-semibold" : "font-normal"} text-xl cursor-pointer "`} onClick={ () =>switchLanguage('en')}>en</div>
            ...
            <div className="flex justify-end">
                ...
                <div className="flex flex-col  space-y-4 transition-all">
                    ...
                    <a href="https://www.instagram.com/iriina.simonyan?igsh=MTNtbnFvMmZldzlheA%3D%3D&utm_source=qr" target="_blank"  className="flex justify-center">
                        ...
                        <InstagramIcon className="w-10 fill-black icon-hover" />
